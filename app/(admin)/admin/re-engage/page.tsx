    ...
    <div className="mx-auto max-w-3xl p-6 md:p-10" dir="rtl">
      <header className="mb-8">
        ...
        <p className="mt-2 text-slate-600">
          שליחת מייל כניסה מחודש לכל יזם שקיבל חשבון בפורטל אבל מעולם לא נכנס.
          כל נמען מקבל סיסמה זמנית חדשה + המייל בנוסח הוותיקים
          (&quot;תוכן ההעשרה שלך עבר לפורטל&quot;) ויתבקש לבחור סיסמה קבועה בכניסה הראשונה.
        </p>
      </header>
