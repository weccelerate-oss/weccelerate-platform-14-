...
const FAQS = [
 ...
 answer:
 'שני הסוגים. יש לנו התאמה למסלול קצר יותר (בלוחות זמנים תלויי-מסלול) לחברות קטנות-בינוניות שרוצות להקים מוצר חדש או לפתח יחידה חדשה. התאגידים הגדולים מקבלים מסלול מלא תקופה תלויית-מסלול.',
 },
 {
