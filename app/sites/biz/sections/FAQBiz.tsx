...
const FAQS = [
 ...
 answer:
 'שלבי אבחון ועיצוב נמשכים בלוחות זמנים תלויי-מסלול. MVP ראשון מוכן בלוחות זמנים מותאמים נוספים. Spin-off מלא עם גיוס ראשון — בדרך כלל בלוחות זמנים תלויי-מסלול מתחילת התהליך. הכל תלוי במורכבות הטכנולוגית ובבשלות השוק.',
 },
 {
 question: 'האם אתם עובדים עם חברות קטנות-בינוניות (SMB) או רק עם תאגידים?',
 answer:
 'שני הסוגים. יש לנו התאמה למסלול קצר יותר (בלוחות זמנים תלויי-מסלול) לחברות קטנות-בינוניות שרוצות להקים מוצר חדש או לפתח יחידה חדשה. התאגידים הגדולים מקבלים מסלול מלא של בלוחות זמנים תלויי-מסלול.',
 },
 {
