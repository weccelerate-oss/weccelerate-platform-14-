...
const JOURNEY = [
  {
    ...
    image: '/images/landing-assets/landing/journey-idea.jpg',
    rotate: -3,
  },
  {
    icon: Rocket,
    ...
    image: '/images/landing-assets/landing/journey-build.jpg',
    rotate: 2,
  },
  {
    icon: Trophy,
    ...
    image: '/images/landing-assets/landing/journey-success.jpg',
    rotate: -2,
  },
];
