...
export const LEUMIT_FAQS: FAQ[] = [
 ...
 answer:
 'כן. יזמים שמתקבלים לתוכנית יכולים לבקש גישה לדאטה אנונימית דרך השותפות עם לאומית, בכפוף לאישור ועדת הלסינקי, התאמה לרגולציית הגנת הפרטיות, ולבקשת מחקר מובנית.',
 },
 {
 question: 'כמה זמן לוקח התהליך?',
 answer:
 'משך הליווי משתנה לפי שלב הסטארטאפ: יזמים בשלב רעיוני משלימים בדרך כלל בלוחות זמנים מותאמים שלב POC ראשוני. סטארטאפים עם מוצר ראשוני (MVP) יכולים לסיים את כל מסלול הרגולציה ולהגיע להכנה לגיוס בלוחות זמנים מותאמים.',
 },
 {
 ...
 answer:
 'WeCcelerate אינה קרן הון סיכון מסורתית, אך אנו עובדים בשילוב עם רשת משקיעים, יזמים ושותפים אסטרטגייםומסייעים בגיוס ישיר מהם. במקרים מסוימים מודל התמחור כולל Equity כחלק מה-Success Fee של התוכנית.',
 },
 {
