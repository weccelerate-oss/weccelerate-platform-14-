...
export const metadata: Metadata = {
  title: 'שירותי MedTech | ייעוץ רגולטורי, ניסויים קליניים ואימות דאטה - WeCcelerate',
  description: 'שירותי MedTech מקצועיים לסטארטאפים רפואיים: ייעוץ רגולטורי (FDA, CE, משרד הבריאות), גישה לניסויים קליניים, ואימות דאטה רפואי. בשיתוף לאומית שירותי בריאות.',
  keywords: [
    'ייעוץ רגולטורי FDA',
    'אישור CE',
...
const medtechServices: Service[] = [
  {
    ...
    subtitle: 'FDA, CE Mark, משרד הבריאות',
    description: 'ליווי מקצועי בתהליכי רגולציה מורכבים - מהכנת התיק הרגולטורי ועד קבלת האישורים הנדרשים לשיווק המוצר בישראל, אירופה וארה"ב.',
    features: [
      'הכנת תיק טכני (Technical File)',
      'ניהול תהליך 510(k) מול ה-FDA',
    ...
    faqs: [
      {
        question: 'כמה זמן לוקח לקבל אישור FDA?',
        questionEn: 'How long does FDA approval take?',
        answer: 'תהליך 510(k) אורך בממוצע 3-6 חודשים מהגשת התיק המלא. אנו מסייעים בהכנת התיק בצורה מקיפה שמפחיתה את הסיכוי לבקשות הבהרה ומקצרת את הזמן לאישור. לפרויקטים מורכבים יותר (PMA), התהליך יכול להימשך 12-18 חודשים.',
      },
      {
  ...
  },
  {
    id: 'clinical-trials',
    icon: FlaskConical,
    title: 'גישה לניסויים קליניים',
    titleEn: 'Clinical Trials Access',
    subtitle: 'פיילוטים ומחקרים קליניים',
    description: 'גישה ייחודית לסביבה קלינית אמיתית דרך רשת המרפאות של לאומית. אפשרות לביצוע פיילוטים, איסוף דאטה קליני, וניסויים קליניים מלאים.',
    features: [
      'גישה ל-450+ מרפאות לאומית',
      'פיילוטים בסביבה קלינית אמיתית',
      'גיוס מטופלים למחקרים',
      'ניהול IRB ואישורי ועדות הלסינקי',
      'איסוף ועיבוד דאטה קליני',
      'ליווי רופאים ומומחים קליניים',
    ],
    faqs: [
      {
        question: 'איך מתבצע פיילוט קליני דרככם?',
        questionEn: 'How does a clinical pilot work through your platform?',
        answer: 'הפיילוט מתחיל בהגדרת פרוטוקול מחקרי יחד עם הצוות הרפואי שלנו. לאחר מכן, אנו בוחרים את המרפאות המתאימות מתוך רשת לאומית, מגייסים מטופלים רלוונטיים, ומלווים את איסוף הדאטה. התהליך כולל אישורי הלסינקי ו-IRB. זמן ממוצע להשקת פיילוט: 2-3 חודשים.',
      },
      {
        question: 'האם הדאטה שנאסף יכול לשמש להגשה לרגולטור?',
        questionEn: 'Can the collected data be used for regulatory submissions?',
        answer: 'בהחלט. הפיילוטים שלנו מתוכננים מראש לעמוד בסטנדרטים רגולטוריים. אנו מקפידים על GCP (Good Clinical Practice) ותיעוד מלא שמאפשר שימוש בדאטה להגשות ל-FDA ו-CE. יש לנו ניסיון בתמיכה במספר הגשות מוצלחות.',
      },
      {
        question: 'כמה מטופלים אפשר לגייס למחקר?',
        questionEn: 'How many patients can you recruit for a study?',
        answer: 'עם גישה ל-2.3 מיליון מבוטחי לאומית, אנו יכולים לגייס מאות ואף אלפי מטופלים למחקרים גדולים. לפיילוטים קטנים, גיוס של 50-200 מטופלים אפשרי תוך שבועות. הגיוס מבוצע בהתאם לקריטריונים שלכם ובאישור ועדת הלסינקי.',
      },
    ],
    cta: {
      text: 'תכננו פיילוט קליני',
      href: '/contact?service=clinical',
    },
    stats: {
      value: '2.3M',
      label: 'מטופלים פוטנציאליים',
    },
  },
  {
    id: 'data-validation',
      ...
      <div className="relative z-10 container-corporate">
        <div className="max-w-3xl">
          ...
          <p className="text-xl text-slate-300 mb-8 max-w-2xl">
            ליווי מקצועי לסטארטאפים רפואיים - מייעוץ רגולטורי, דרך ניסויים קליניים,
            ועד גישה לדאטה רפואי ייחודי.
          </p>
          ...
          <div className="flex flex-wrap gap-6">
            <div className="flex items-center gap-2 text-slate-400">
              ...
              <span>95% הצלחה באישורים רגולטוריים</span>
            </div>
            <div className="flex items-center gap-2 text-slate-400">
