    ...
    faqs: [
      {
        ...
        answer: 'תהליך אישור CE אורך בממוצע 3-6 חודשים מהגשת התיק המלא. אנו מסייעים בהכנת התיק בצורה מקיפה שמפחיתה את הסיכוי לבקשות הבהרה ומקצרת את הזמן לאישור. לפרויקטים מורכבים יותר, התהליך יכול להימשך 12-18 חודשים.',
      },
      {
    ...
    faqs: [
      {
        ...
        answer: 'אנו מחברים את היזם לרופאים מומחים בתחום הרלוונטי מתוך רשת לאומית. הרופאים בוחנים את המיזם מבחינה קלינית ומספקים חוות דעת מקצועית על הרלוונטיות, הפוטנציאל והאתגרים. התהליך אורך בממוצע 2-4 שבועות.',
      },
      {
