...
function EventsSection({ events }: { events: Array<{ id: string; name: string; slug: string; description: string | null; date: Date; time: string | null; city: string | null; category: string | null; imageUrl?: string | null }> }) {
  return (
      ...
      <main id="main-content">
        ...
        <section className="section-padding bg-white">
          <div className="container-corporate">
            ...
            <VideoGallery videos={videos} showPlaylist={true} />
          </div>
        </section>
