...
export const metadata: Metadata = constructMetadata({
  ...
  description:
    'מדריך מקיף לגיוס הון בישראל: Pre-Seed, Seed, Series A, גרנטים של רשות החדשנות, Pitch Deck, תוכנית עסקית, SAFE, Cap Table, ESOP, Vesting ואקזיט. 11 מדריכים מקצועיים מבונה המיזמים המוביל בישראל.',
  keywords: [
    'גיוס הון',
    'גיוס הון לסטארטאפ',
    'גיוס הון למיזם',
      ...
      <main className="min-h-screen bg-white" id="main-content">
        <div className="mx-auto max-w-5xl px-4 py-12 md:py-16" dir="rtl">
          ...
          <header className="mb-12">
            ...
            >
              מדריך מרכזי לכל יזם ישראלי שמתכוון לגייס הון. {linkedGuides.length} מדריכים מקצועיים מבונה
              המיזמים המוביל בישראל — מ-Pre-Seed ועד אקזיט. החברות בפורטפוליו של WeCcelerate גייסו יחד מעל
              150M$, דרך רשת של 200+ משקיעים מאומתים. כל מדריך מבוסס על תהליכים אמיתיים שעברו אצלנו ב-2024-2026.
            </p>

            {/* Quick stats */}
            <dl className="mt-8 grid grid-cols-2 gap-6 rounded-xl border border-slate-200 bg-slate-50 p-6 md:grid-cols-4">
              <div>
                <dt className="text-xs uppercase tracking-wide text-slate-500">פורטפוליו</dt>
                <dd className="mt-1 text-2xl font-bold text-slate-900">40+</dd>
                <dd className="text-xs text-slate-600">מיזמים שליווינו</dd>
              </div>
              <div>
                <dt className="text-xs uppercase tracking-wide text-slate-500">גיוסים</dt>
                <dd className="mt-1 text-2xl font-bold text-slate-900">$150M+</dd>
                <dd className="text-xs text-slate-600">סה"כ גויס</dd>
              </div>
              <div>
                <dt className="text-xs uppercase tracking-wide text-slate-500">משקיעים</dt>
                <dd className="mt-1 text-2xl font-bold text-slate-900">200+</dd>
                <dd className="text-xs text-slate-600">ברשת מאומתת</dd>
              </div>
              <div>
                <dt className="text-xs uppercase tracking-wide text-slate-500">מדריכים</dt>
                <dd className="mt-1 text-2xl font-bold text-slate-900">{linkedGuides.length}</dd>
                <dd className="text-xs text-slate-600">בpillar הזה</dd>
              </div>
            </dl>
          </header>
          ...
          <section className="mt-16 rounded-2xl border border-blue-200 bg-blue-50 p-8">
            ...
            <p data-speakable className="text-slate-800 leading-relaxed">
              WeCcelerate, בונה המיזמים המוביל בישראל, מציעה למיזמים שני שירותי גיוס: (1) הכנה מקצועית
              למשקיעים — Pitch Deck, מודל פיננסי, Data Room, וסבבי Pitch Practice. (2) חיבור ישיר לרשת של
              200+ משקיעים מאומתים בישראל ובארה"ב דרך היכרויות חמות. החברות בפורטפוליו שלנו גייסו יחד מעל
              150 מיליון דולר, עם זמן ממוצע של 4 חודשים מתחילת פגישות לסגירה.
            </p>
          </section>
