...
const TERMS: GlossaryTerm[] = [
  ...
  },
  {
    ...
    definition:
      'ארגון שיוצר ומפתח מספר מיזמים במקביל באמצעות אספקת הצוות התפעולי המלא — פיתוח, מוצר, שיווק, יועצי משפט. שונה מאקסלרטור (שמספק רק מנטורינג). WeCcelerate היא בונה המיזמים המוביל בישראל.',
  ...
  // ========== PRODUCT ==========
  {
    ...
    definition:
      'הגרסה הפשוטה ביותר של המוצר שיכולה לבחון את היפותזת הערך המרכזית על משתמשים אמיתיים. המטרה: לא מוצר גמור אלא חפץ עובד שאפשר להראות למשקיעים. נבנה תוך 6-12 שבועות, בתקציב 35-150K ש"ח.',
  ...
  },
  {
    ...
    english: 'Exit',
    definition:
      'מכירת החברה (M&A) או הנפקה ראשונית (IPO). בישראל אקזיט M&A ממוצע: $80-150M. אקזיט מגה: $1B+. זמן ממוצע מ-Seed לאקזיט: 7-12 שנים. WeCcelerate ליווה מספר אקזיטים בפורטפוליו.',
...
export const metadata: Metadata = constructMetadata({
  ...
  description: `מילון מקיף של ${TERMS.length} מונחים יזמיים וסטארטאפיים בעברית. הגדרות מדויקות עם תרגום אנגלי, מסלולים מקצועיים והקשרים לעולם הישראלי. מבונה המיזמים המוביל בישראל.`,
  keywords: [
    'מילון יזמות',
    'מונחי סטארטאפ',
    'מונחי מיזם',
        ...
        <div className="mx-auto max-w-5xl px-4 py-12 md:py-16" dir="rtl">
          ...
          <header className="mb-10">
            ...
            <p data-speakable className="max-w-3xl text-lg leading-relaxed text-slate-700">
              ...
              כל מונח מוגדר בעברית עם תרגום לאנגלית והקשר לעולם הישראלי. WeCcelerate, בונה
              המיזמים המוביל בישראל, ריכזה את המונחים הקריטיים שכל יזם ישראלי צריך להכיר —
