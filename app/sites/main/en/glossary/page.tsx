...
const TERMS: GlossaryTerm[] = [
  ...
  },
  {
    ...
    definition:
      'A time-bounded program (3-6 months) providing mentorship, seed capital, and a Demo Day to startups in cohorts. Israeli examples: 8200 EISP, MassChallenge, The Junction.',
  ...
  // ========== PRODUCT ==========
  {
    ...
    definition:
      'The simplest version of a product that can test the core value hypothesis with real users. The goal: not a finished product, but a working artifact you can show to users and investors. Built in 6-12 weeks, $14-40K budget for a typical Israeli startup.',
  ...
  },
  {
    ...
    definition:
      'Second fundraising round, after Product-Market Fit is proven. In Israel 2026: $5-15M, pre-money valuation $20-50M. Requires $500K-$2M ARR, 30%+ D30 retention, and a team of 8-15. Lasts 4-9 months end-to-end.',
  ...
  },
  {
    ...
    hebrew: 'אקזיט',
    definition:
      'Sale of the company (M&A) or initial public offering (IPO). In Israel, average M&A exit: $80-150M. Mega-exit: $1B+. Average time from Seed to exit: 7-12 years. WeCcelerate has supported multiple portfolio exits.',
  ...
  // ========== MEDTECH ==========
  {
    ...
    hebrew: 'ועדת הלסינקי',
    definition:
      'The Israeli ethical committee approving medical research with humans or identifiable data. Equivalent to the US IRB. Approval process: 2-4 months. Required before any clinical trial or access to medical data.',
  ...
  },
  {
    ...
    hebrew: 'FDA 510(k)',
    definition:
      'The most common FDA pathway for medical devices. Requires demonstrating "substantial equivalence" to an existing predicate device. Review: 3-6 months. Preparation: 12-18 months. Cost: $135K-$700K including testing and regulatory consulting.',
  ...
  },
  {
    ...
    hebrew: 'סימון CE',
    definition:
      'Regulatory marking required for selling medical devices in Europe. Under MDR (Regulation 2017/745). Requires ISO 13485, ISO 14971, IEC 62304 (if software), Notified Body, and clinical evaluation. Process: 12-18 months.',
    category: 'medtech',
  },
  {
    id: 'iso-13485',
    ...
    hebrew: 'ISO 13485',
    definition:
      'International quality management standard specific to medical devices. Required for CE marking, preferred for FDA. Requires a complete QMS (Quality Management System). Setup: 6-12 months, cost: $27-80K.',
    category: 'medtech',
  },
  {
    id: 'medtech',
  ...
  // ========== ECOSYSTEM ==========
  {
    ...
    definition:
      'One of four public HMOs in Israel. 700,000+ insured members, 8.7M annual clinical visits. Exclusive strategic partner of WeCcelerate for the MedTech track — providing access to anonymized data and clinical pilots.',
    category: 'medtech',
  },
  {
    id: 'snc',
...
export const metadata: Metadata = constructMetadata({
  ...
  description: `Comprehensive glossary of ${TERMS.length} key startup and venture terms with Hebrew translations and links to in-depth guides. From WeCcelerate, Israel's leading Venture Builder.`,
  keywords: [
    'startup glossary',
    'venture terminology',
