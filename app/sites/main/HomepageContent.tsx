        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-2.5 mb-6">
              ...
              <a href="https://www.instagram.com/weccelerate.ltd" target="_blank" rel="noopener noreferrer" aria-label={t('footer.instagram')} className="w-10 h-10 bg-white/5 flex items-center justify-center rounded-lg hover:bg-[#E4405F]/20 hover:text-[#E4405F] text-white/60 transition-all">
              ...
              {/* Owned WeCcelerate social profiles. Twitter/X and GitHub are
                  intentionally NOT shown — Twitter is not company-owned;
                  GitHub is not user-facing. */}
