...
// =============================================================================
// STEP IMAGES — exact filenames from the client
// =============================================================================

const stepImages = [
  '/images/services/marketing/Digital-Advertising.png',
  '/images/services/marketing/PR.png',
  '/images/services/marketing/Social-Media-Marketing.png',
  '/images/services/marketing/Marketing-Strategy.png',
];
...
function TimelineCard({
  ...
  return (
    ...
    >
      {/* Card — scroll reveal: y:40→0, opacity:0→1 */}
      <motion.div
        ref={ref}
      ...
      >
        ...
        >
          ...
          {/* Card image — hover zoom effect (scale 1.02) */}
...
export default function MarketingTimeline() {
  ...
  // Gold line "fills up" as user scrolls
  const lineHeight = useTransform(scrollYProgress, [0, 1], ['0%', '100%']);

  const steps: StepData[] = [
    {
      number: 1,
      title: t('service.marketing.step4.title'),
      text: t('service.marketing.step4.text'),
      highlights: [
        t('service.marketing.step4.h1'),
        t('service.marketing.step4.h2'),
        t('service.marketing.step4.h3'),
        t('service.marketing.step4.h4'),
      ],
      image: stepImages[3],
    },
    {
      number: 2,
      title: t('service.marketing.step1.title'),
      text: t('service.marketing.step1.text'),
      highlights: [
        t('service.marketing.step1.h1'),
        t('service.marketing.step1.h2'),
        t('service.marketing.step1.h3'),
        t('service.marketing.step1.h4'),
      ],
      image: stepImages[0],
    },
    {
      number: 3,
      title: t('service.marketing.step2.title'),
      text: t('service.marketing.step2.text'),
      highlights: [
        t('service.marketing.step2.h1'),
        t('service.marketing.step2.h2'),
        t('service.marketing.step2.h3'),
        t('service.marketing.step2.h4'),
      ],
      image: stepImages[1],
    },
    {
      number: 4,
      title: t('service.marketing.step3.title'),
      text: t('service.marketing.step3.text'),
      highlights: [
        t('service.marketing.step3.h1'),
        t('service.marketing.step3.h2'),
        t('service.marketing.step3.h3'),
        t('service.marketing.step3.h4'),
      ],
      image: stepImages[2],
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="container-corporate relative z-10 mb-16 text-center">
        ...
        >
          {t('service.marketing.timeline.tag')}
        </motion.span>
        <motion.h2
        ...
        >
          {t('service.marketing.timeline.heading')}
        </motion.h2>
      </div>
