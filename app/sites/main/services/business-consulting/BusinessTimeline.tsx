...
function TimelineCard({
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ...
          <div
            ...
            style={{ [isLeft ? 'borderRight' : 'borderLeft']: 'none', [isLeft ? 'borderTop' : 'borderBottom']: 'none' }}
          />

          {/* Card image — faded background layer */}
      ...
      {/* Center node (visible on desktop) — positioned absolutely on the timeline */}
      <motion.div
        initial={{ scale: 0 }}
      ...
      {/* Mobile node — inline before card */}
      <motion.div
        initial={{ scale: 0 }}
        animate={isInView ? { scale: 1 } : { scale: 0 }}
        transition={{ duration: 0.4, delay: 0.2 }}
...
export default function BusinessTimeline() {
  ...
  // The gold line "fills up" as user scrolls
  const lineHeight = useTransform(scrollYProgress, [0, 1], ['0%', '100%']);

  const steps: StepData[] = [
    {
      number: 1,
      title: t('service.consulting.step1.title'),
      text: t('service.consulting.step1.text'),
      highlights: [t('service.consulting.step1.h1'), t('service.consulting.step1.h2'), t('service.consulting.step1.h3'), t('service.consulting.step1.h4')],
      image: stepImages[0],
    },
    {
      number: 2,
      title: t('service.consulting.step2.title'),
      text: t('service.consulting.step2.text'),
      highlights: [t('service.consulting.step2.h1'), t('service.consulting.step2.h2'), t('service.consulting.step2.h3'), t('service.consulting.step2.h4')],
      image: stepImages[1],
    },
    {
      number: 3,
      title: t('service.consulting.step3.title'),
      text: t('service.consulting.step3.text'),
      highlights: [t('service.consulting.step3.h1'), t('service.consulting.step3.h2'), t('service.consulting.step3.h3'), t('service.consulting.step3.h4')],
      image: stepImages[2],
    },
    {
      number: 4,
      title: t('service.consulting.step4.title'),
      text: t('service.consulting.step4.text'),
      highlights: [t('service.consulting.step4.h1'), t('service.consulting.step4.h2'), t('service.consulting.step4.h3'), t('service.consulting.step4.h4')],
      image: stepImages[3],
    },
    {
      number: 5,
      title: t('service.consulting.step5.title'),
      text: t('service.consulting.step5.text'),
      highlights: [t('service.consulting.step5.h1'), t('service.consulting.step5.h2'), t('service.consulting.step5.h3'), t('service.consulting.step5.h4')],
      image: stepImages[4],
    },
    {
      number: 6,
      title: t('service.consulting.step6.title'),
      text: t('service.consulting.step6.text'),
      highlights: [t('service.consulting.step6.h1'), t('service.consulting.step6.h2'), t('service.consulting.step6.h3'), t('service.consulting.step6.h4')],
      image: stepImages[5],
    },
    {
      number: 7,
      title: t('service.consulting.step7.title'),
      text: t('service.consulting.step7.text'),
      highlights: [t('service.consulting.step7.h1'), t('service.consulting.step7.h2'), t('service.consulting.step7.h3'), t('service.consulting.step7.h4')],
      image: stepImages[6],
    },
  ];
  ...
  return (
    ...
    >
      ...
      <div className="container-corporate relative z-10 mb-16 text-center">
        ...
        >
          {t('service.consulting.timeline.tag')}
        </motion.span>
        <motion.h2
        ...
        >
          {t('service.consulting.timeline.heading')}
        </motion.h2>
      </div>
      ...
      <div className="container-corporate relative z-10">
        ...
        <div className="hidden lg:block absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-px">
          ...
          {/* Filled line (glowing gold on scroll) */}
          <motion.div
