...
const stepImages = [
  '/images/A_futuristic_hud_2k_202602191813.jpeg',
  '/images/Highend_3d_cad_2k_202602191815.jpeg',
  '/images/A_sleek_dark_2k_202602220953.jpeg',
  '/images/A_stateoftheart_3d_2k_202602191815.jpeg',
  '/images/A_clean_futuristic_2k_202602191813.jpeg',
];

const spanMap = ['md:col-span-2', '', '', 'md:col-span-2', 'md:col-span-3'];
  ...
  return (
    <section className="relative py-20 sm:py-28 overflow-hidden">
      ...
      <div className="container-corporate relative z-10 mb-12 sm:mb-16 text-center">
        <motion.span initial={{ opacity: 0, y: 10 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="inline-block text-[#c8a951] text-sm font-bold uppercase tracking-[0.3em] mb-4">{t('service.physical.timeline.tag')}</motion.span>
        <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: 0.1 }} className="text-3xl sm:text-4xl md:text-5xl font-bold text-white tracking-tight">{t('service.physical.timeline.heading')}</motion.h2>
      </div>
