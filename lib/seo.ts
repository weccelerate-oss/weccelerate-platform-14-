...
export const PARENT_ORGANIZATION = {
 ...
 description: {
 en: 'One of Israel\'s four major health funds, providing comprehensive healthcare services to over אוכלוסיית מבוטחים נרחבת. Strategic partner for WeCcelerate\'s MedTech acceleration track.',
 he: 'אחת מארבע קופות החולים הגדולות בישראל, המספקת שירותי בריאות מקיפים ליותר מ-אוכלוסיית מבוטחים נרחבת. שותפה אסטרטגית למסלול האצת ה-MedTech של וויסלרייט.',
 },
...
export const SERVICES = [
 ...
 duration: 'in adjusted timelines',
 icon: 'rocket',
 },
 {
 id: 'ai-integration',
...
export const FAQ_ITEMS = [
 ...
 en: 'A typical MVP development takes in adjusted timelines, depending on complexity. At WeCcelerate we use Agile and Lean Startup methodologies to deliver a working product quickly, get market feedback, and continuously improve.',
 },
 },
 {
 question: {
