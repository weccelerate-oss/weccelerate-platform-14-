...
export const mockVideos: VideoItem[] = [
  ...
  { id: 'clip-coffee', title: 'האם הקפה הוא הדלק שמניע אתכם? — מאחורי הקלעים ב-WeCcelerate', description: 'קליפ קליל מאחורי הקלעים של וויסלרייט: על תרבות הקפה במשרדי WeCcelerate, רגעי השראה בין פגישות ייעוץ ואיך נראה יום עבודה במאיץ סטארטאפים בישראל.', category: 'reels', videoUrl: 'https://www.youtube.com/watch?v=IqW-Shk8nL8', provider: 'youtube', isFeatured: false, tags: ['מאחורי הקלעים', 'תרבות', 'WeCcelerate', 'משרד'] },
];
...
export const mockSuccessStories: SuccessStory[] = [
  ...
  // --- Website Testimonials (wecc-ltd.com / weccelerate.as7.co.il) ---
  {
    ...
    quoteEn: 'I came to WeCcelerate after a few attempts on my own. From the very first moment it clicked — they came with genuine intentions, we started a process together, built a business and financial plan, and within 4 months I had already closed an investment. Today we run marketing together and I couldn\'t be happier. I recommend them to anyone who wants to work with true professionals.',
    personName: 'רותם לוי',
    personNameEn: 'Rotem Levy',
    personRole: 'מייסד',
    personRoleEn: 'Founder',
    personImage: '/images/reviews/rotem-levi.jpg',
    industry: 'סטארטאפ',
    industryEn: 'Startup',
    metrics: [{ label: 'זמן להשקעה', labelEn: 'Time to investment', value: '4 חודשים', valueEn: '4 months' }],
    isFeatured: true,
  ...
  },
  {
    ...
    quoteEn: 'I\'m a seasoned entrepreneur who has already built several startups. I\'m long past the pizza-in-the-garage-at-midnight stage. I was looking for a professional team to help move my venture forward, and at WeCcelerate I found a home for everything the company needs. I know what has to be done, but you don\'t reach the moon alone. WeCcelerate is an amazing, professional team that found a solution to every challenge I threw at them.',
    personName: 'גיא שם',
    personNameEn: 'Guy Sham',
    personRole: 'יזם מנוסה',
    personRoleEn: 'Serial Entrepreneur',
  ...
  },
  {
    ...
    quoteEn: 'I approached WeCcelerate at the idea stage. My product is physical — it involves development and manufacturing in China, plus logistics, importing, standards certifications and, of course, marketing and sales. WeCcelerate gave me end-to-end support, from market research to sourcing manufacturers around the world and building a sales website and marketing. I recommend them to anyone who wants to bring their personal dream to life.',
    personName: 'אריאל סנה',
    personNameEn: 'Ariel Sneh',
    personRole: 'מייסדת',
    personRoleEn: 'Founder',
    personImage: '/images/reviews/ariel-sena.jpg',
    industry: 'מוצר פיזי',
    industryEn: 'Physical Product',
    metrics: [{ label: 'שירותים', labelEn: 'Services', value: 'מחקר → ייצור → שיווק', valueEn: 'Research → Manufacturing → Marketing' }],
    isFeatured: true,
    collaborationDate: '2024',
  },
  {
    ...
    quoteEn: 'I came to WeCcelerate with a rough, unpolished idea. We sat down with the team and realized my vision was big, but building something real takes a structured work plan and clear, sharp goals. WeCcelerate has been with me for two years now — they helped me with a business plan, financial planning, marketing, platform development and fundraising. I believe anyone who wants to succeed should learn the WeCcelerate method.',
    personName: 'אלעד גובס',
    personNameEn: 'Elad Govs',
    personRole: 'מייסד',
    personRoleEn: 'Founder',
    personImage: '/images/reviews/elad-govs.jpg',
    industry: 'אופנה / E-Commerce',
    industryEn: 'Fashion / E-Commerce',
    metrics: [{ label: 'שיתוף פעולה', labelEn: 'Collaboration', value: '2+ שנים', valueEn: '2+ years' }],
    isFeatured: true,
  ...
  // --- Google Reviews ---
  {
    ...
    quoteEn: 'With genuine sensitivity, they guide ventures on their way to becoming startups without ever losing sight of the person behind the idea. The personal connection, the ability to tailor a precise fit for every venture, and their encouraging presence exactly at the moments that matter most — that\'s what makes WeCcelerate such a special place.',
    personName: 'לירז כהן ביטון',
    personNameEn: 'Liraz Cohen Biton',
    personRole: 'יזמת',
    personRoleEn: 'Entrepreneur',
  ...
  // --- Press / Articles ---
  {
    ...
    quoteEn: 'WeCcelerate helped me recruit a senior executive for my private venture. Their professionalism and network are exceptional.',
    personName: 'דני טופז',
    personNameEn: 'Dani Topaz',
    personRole: 'יזם סדרתי, לשעבר CEO M-Lot',
    personRoleEn: 'Serial Entrepreneur, Former CEO of M-Lot',
    personImage: '/images/reviews/dani-tofez.jpg',
    industry: 'השקעות / סטארטאפ',
    industryEn: 'Investments / Startup',
    metrics: [{ label: 'אקזיט קודם', labelEn: 'Previous exit', value: '₪900M', valueEn: '₪900M' }],
    collaborationDate: '2024',
  },
  ...
  // =========================================================================
  {
    ...
    quoteEn: 'A highly professional company. They guide you through every stage and never leave you on your own. Highly recommended!',
    personName: 'יוסי אברהם',
    personNameEn: 'Yossi Avraham',
    personRole: 'מייסד',
    personRoleEn: 'Founder',
  ...
  },
  {
    ...
    quoteEn: 'From the very first moment I felt I was in good hands. The team understands business and knows how to give you real tools. A huge thank you!',
    personName: 'מיכל דוד',
    personNameEn: 'Michal David',
    personRole: 'יזמת',
    personRoleEn: 'Entrepreneur',
  ...
  },
  {
    ...
    quoteEn: 'They helped me from an idea in my head all the way to a product sitting on the shelf. True professionals who understand the entire process.',
    personName: 'אורי כהן',
    personNameEn: 'Ori Cohen',
    personRole: 'מייסד',
    personRoleEn: 'Founder',
  ...
  },
  {
    ...
    quoteEn: 'The business and regulatory guidance was amazing. Thanks to WeCcelerate, we were able to navigate regulatory committees smoothly.',
    personName: 'ד״ר נעמה לוי',
    personNameEn: 'Dr. Naama Levy',
    personRole: 'מייסדת שותפה',
    personRoleEn: 'Co-Founder',
    personImage: '/images/reviews/naama-levi.jpg',
    industry: 'בריאות דיגיטלית',
    industryEn: 'Digital Health',
    collaborationDate: '2024',
  },
  {
    id: 'story-g-11',
    ...
    quoteEn: 'The WeCcelerate team operates at a world-class level. An excellent business plan, financials, and a clear strategy. They are the reason we managed to raise.',
    personName: 'עידן שמש',
    personNameEn: 'Idan Shemesh',
    personRole: 'CEO & Co-Founder',
    personRoleEn: 'CEO & Co-Founder',
  ...
  },
  {
    ...
    quoteEn: 'Social ventures have a place here too. They supported me with the same seriousness as a tech startup. I appreciate it deeply.',
    personName: 'שירה ברק',
    personNameEn: 'Shira Barak',
    personRole: 'מייסדת',
    personRoleEn: 'Founder',
    personImage: '/images/reviews/shira-barak.jpg',
    industry: 'Social Impact',
    industryEn: 'Social Impact',
    collaborationDate: '2024',
  },
  {
    id: 'story-g-13',
    ...
    quoteEn: 'They built us a business and marketing plan from day one. Their understanding of both the Israeli and international markets helped us scale.',
    personName: 'תומר גולן',
    personNameEn: 'Tomer Golan',
    personRole: 'מייסד',
    personRoleEn: 'Founder',
  ...
  },
  {
    ...
    quoteEn: 'Amazing support on the MedTech track. The connection to Leumit and to medical experts helped us make significant progress.',
    personName: 'רון מזרחי',
    personNameEn: 'Ron Mizrachi',
    personRole: 'CTO',
    personRoleEn: 'CTO',
  ...
  },
  {
    ...
    quoteEn: 'They came prepared with deep market research and helped me build a pitch deck that made investors actually listen. Genuine service.',
    personName: 'נועם ישראלי',
    personNameEn: 'Noam Israeli',
    personRole: 'מייסד',
    personRoleEn: 'Founder',
  ...
  },
  {
    ...
    quoteEn: 'A comprehensive financial plan, a clear revenue model, and fundraising support. WeCcelerate are true partners, not service providers.',
    personName: 'אלון פרידמן',
    personNameEn: 'Alon Friedman',
    personRole: 'CEO',
    personRoleEn: 'CEO',
  ...
  },
  {
    ...
    quoteEn: 'End-to-end support — from product definition, through building an MVP, to the first meeting with investors. A dedicated, professional team.',
    personName: 'דנה לבנון',
    personNameEn: 'Dana Levanon',
    personRole: 'מייסדת',
    personRoleEn: 'Founder',
  ...
  },
  {
    ...
    quoteEn: 'The logistics world is complex, but WeCcelerate helped me map the market, build a clear strategy, and raise a seed round.',
    personName: 'יהונתן רוט',
    personNameEn: 'Yehonatan Roth',
    personRole: 'מייסד',
    personRoleEn: 'Founder',
  ...
  },
  {
    ...
    quoteEn: 'WeCcelerate\'s expertise in climate and clean energy genuinely surprised me. They found me relevant connections and helped at every stage.',
    personName: 'מאיה ברגר',
    personNameEn: 'Maya Berger',
    personRole: 'מייסדת שותפה',
    personRoleEn: 'Co-Founder',
    personImage: '/images/reviews/maya-berger.jpg',
    industry: 'CleanTech',
    industryEn: 'CleanTech',
    collaborationDate: '2024',
  },
  {
    id: 'story-g-20',
    ...
    quoteEn: 'WeCcelerate changed the way I see my business. From "I have an idea" to "I have a company with a clear plan and investors."',
    personName: 'איתמר וייס',
    personNameEn: 'Itamar Weiss',
    personRole: 'מייסד',
    personRoleEn: 'Founder',
    personImage: '/images/reviews/itamar-weiss.jpg',
    industry: 'ספורט / Wellness',
    industryEn: 'Sports / Wellness',
    collaborationDate: '2024',
  },
  {
    id: 'story-g-21',
    ...
    quoteEn: 'Uncompromising professionalism. The financial plan they built was so precise that the investor said it was one of the best he had ever seen.',
    personName: 'יעל שלום',
    personNameEn: 'Yael Shalom',
    personRole: 'Co-Founder',
    personRoleEn: 'Co-Founder',
    personImage: '/images/reviews/yael-shalom.jpg',
    industry: 'InsurTech',
    industryEn: 'InsurTech',
    collaborationDate: '2024',
  },
  {
    id: 'story-g-22',
    ...
    quoteEn: 'After a long time trying on my own, WeCcelerate were the missing piece. Experts in every field — available and dedicated.',
    personName: 'אמיר לוי',
    personNameEn: 'Amir Levy',
    personRole: 'מייסד',
    personRoleEn: 'Founder',
  ...
  },
  {
    ...
    quoteEn: 'They built me an impressive brand book, a sales website, and a digital marketing plan. Within two months I already had my first sales.',
    personName: 'נויה אזולאי',
    personNameEn: 'Noya Azoulay',
    personRole: 'מייסדת',
    personRoleEn: 'Founder',
    personImage: '/images/reviews/noya-azoulay.jpg',
    industry: 'אופנה',
    industryEn: 'Fashion',
    metrics: [{ label: 'זמן למכירה ראשונה', labelEn: 'Time to first sale', value: 'חודשיים', valueEn: '2 months' }],
    collaborationDate: '2024',
  },
  {
    id: 'story-g-24',
    ...
    quoteEn: 'WeCcelerate\'s grasp of the food industry is remarkable. They helped me with regulation, manufacturing, and supply-chain planning.',
    personName: 'עופר כרמלי',
    personNameEn: 'Ofer Carmeli',
    personRole: 'מייסד',
    personRoleEn: 'Founder',
  ...
  },
  {
    ...
    quoteEn: 'My technical team is excellent, but they didn\'t know how to speak to investors. WeCcelerate taught us to translate technology into business language.',
    personName: 'אביב שרון',
    personNameEn: 'Aviv Sharon',
    personRole: 'CTO & Co-Founder',
    personRoleEn: 'CTO & Co-Founder',
    personImage: '/images/reviews/aviv-sharon.jpg',
    industry: 'AI / בינה מלאכותית',
    industryEn: 'AI / Artificial Intelligence',
    collaborationDate: '2024',
  },
  {
    id: 'story-g-26',
    ...
    quoteEn: 'As a venture with a social mission, I was looking for someone who would understand my vision. WeCcelerate showed both sensitivity and professionalism in every meeting.',
    personName: 'טלי גבע',
    personNameEn: 'Tali Geva',
    personRole: 'מייסדת',
    personRoleEn: 'Founder',
  ...
  },
  {
    ...
    quoteEn: 'From idea to launch — WeCcelerate were there every step of the way. Market research, product definition, design, development, and investor support. Simply WOW.',
    personName: 'דביר מלכה',
    personNameEn: 'Dvir Malka',
    personRole: 'מייסד',
    personRoleEn: 'Founder',
    personImage: '/images/reviews/dvir-malka.jpg',
    industry: 'Marketplace',
    industryEn: 'Marketplace',
    collaborationDate: '2024',
  },
  {
    id: 'story-g-28',
    ...
    quoteEn: 'The track with Leumit opened doors we never dreamed of. Access to physicians, clinical research, and regulatory support. Worth every shekel.',
    personName: 'ד״ר שי גרוסמן',
    personNameEn: 'Dr. Shai Grossman',
    personRole: 'מייסד',
    personRoleEn: 'Founder',
  ...
  },
  {
    ...
    quoteEn: 'WeCcelerate\'s network in the cyber world surprised me. They connected me with investors and mentors who were a perfect fit for my field.',
    personName: 'גל סגל',
    personNameEn: 'Gal Segal',
    personRole: 'CEO',
    personRoleEn: 'CEO',
  ...
  },
  {
    ...
    quoteEn: 'I got personal, hands-on support. Not for a moment did I feel like just another client — they were true partners for the journey. I warmly recommend them to any entrepreneur.',
    personName: 'ניר אלבז',
    personNameEn: 'Nir Elbaz',
    personRole: 'מייסד',
    personRoleEn: 'Founder',
  ...
  },
  {
    ...
    quoteEn: 'They built me a brilliant marketing plan tailored precisely to the tourism industry. Deep understanding and courteous service.',
    personName: 'שלי רביבו',
    personNameEn: 'Sheli Ravivo',
    personRole: 'מייסדת',
    personRoleEn: 'Founder',
  ...
  },
  {
    ...
    quoteEn: 'They bridged the hardware world and the business world perfectly. Business plan, DFM, and manufacturer sourcing — all under one roof.',
    personName: 'אדם רוזנברג',
    personNameEn: 'Adam Rosenberg',
    personRole: 'CTO',
    personRoleEn: 'CTO',
  ...
  },
  {
    ...
    quoteEn: 'WeCcelerate aren\'t just advisors — they believe in your venture. Their emotional investment in your success is felt in every meeting.',
    personName: 'רותם יפה',
    personNameEn: 'Rotem Yafe',
    personRole: 'מייסדת',
    personRoleEn: 'Founder',
  ...
  },
  {
    ...
    quoteEn: 'I thought an accelerator wasn\'t a fit for the gaming industry, but WeCcelerate proved me wrong. Professional and flexible.',
    personName: 'יובל כץ',
    personNameEn: 'Yuval Katz',
    personRole: 'מייסד',
    personRoleEn: 'Founder',
  ...
  },
  {
    ...
    quoteEn: 'They helped me build an MVP in 3 months and reach our first 1,000 users. Their business guidance was critical to our success.',
    personName: 'הדר ענבר',
    personNameEn: 'Hadar Inbar',
    personRole: 'מייסדת',
    personRoleEn: 'Founder',
    personImage: '/images/reviews/hadar-inbar.jpg',
    industry: 'EdTech',
    industryEn: 'EdTech',
    metrics: [{ label: 'משתמשים ראשונים', labelEn: 'First users', value: '1,000', valueEn: '1,000' }],
    collaborationDate: '2024',
  },
  {
    id: 'story-g-36',
    ...
    quoteEn: 'WeCcelerate guided us with impact-investing funds and helped us raise a seed round. Professional, patient, and dedicated.',
    personName: 'עומר דביר',
    personNameEn: 'Omer Dvir',
    personRole: 'CEO',
    personRoleEn: 'CEO',
    personImage: '/images/reviews/omer-dvir.jpg',
    industry: 'Accessibility Tech',
    industryEn: 'Accessibility Tech',
    collaborationDate: '2024',
  },
  {
    id: 'story-g-37',
    ...
    quoteEn: 'WeCcelerate\'s experience in biotech and their familiarity with regulation in Israel and Europe saved us months of work.',
    personName: 'ד״ר מירב שפירא',
    personNameEn: 'Dr. Merav Shapira',
    personRole: 'מייסדת שותפה',
    personRoleEn: 'Co-Founder',
  ...
  },
  {
    ...
    quoteEn: 'As a former senior IDF officer, I was looking for someone who could translate my military experience into a business. WeCcelerate did it brilliantly.',
    personName: 'אלי בן-דוד',
    personNameEn: 'Eli Ben-David',
    personRole: 'מייסד',
    personRoleEn: 'Founder',
    personImage: '/images/reviews/eli-ben-david.jpg',
    industry: 'Defense Tech',
    industryEn: 'Defense Tech',
    collaborationDate: '2024',
  },
  {
    id: 'story-g-39',
    ...
    quoteEn: 'Excellent market research, a precise financial plan, and hands-on support with investors. WeCcelerate are best in class.',
    personName: 'ליאור אשכנזי',
    personNameEn: 'Lior Ashkenazi',
    personRole: 'Co-Founder',
    personRoleEn: 'Co-Founder',
  ...
  },
  {
    ...
    quoteEn: 'We started with business consulting and ended up with an investment, a product, and paying customers. WeCcelerate changed our lives. Thank you!',
    personName: 'נטע סרוסי',
    personNameEn: 'Neta Seroussi',
    personRole: 'מייסדת',
    personRoleEn: 'Founder',
    personImage: '/images/reviews/neta-seroussi.jpg',
    industry: 'RetailTech',
    industryEn: 'RetailTech',
    metrics: [{ label: 'תוצאה', labelEn: 'Outcome', value: 'השקעה + לקוחות', valueEn: 'Investment + customers' }],
    collaborationDate: '2024',
  },
];
