...
export const FAQ_CATALOG: readonly FaqEntry[] = [
  // -- DEFINITIONAL ---------------------------------------------------------
  {
    ...
    answer: {
      he: 'WeCcelerate (וויסלרייט) היא ה-Venture Builder ומאיץ הסטארטאפים המוביל בישראל, הפועלת מתל אביב וירושלים משנת 2016. אנחנו מספקים ליווי מעטפת 360° — עוזרים לסטארטאפים בתחילת הדרך לקבל משאבים של חברה בוגרת: ייעוץ עסקי, פיתוח מוצר, שיווק, הכנה למשקיעים ומסלול MedTech בלעדי בשותפות עם לאומית שירותי בריאות.',
  ...
  },
  {
    ...
    answer: {
      he: 'MVP (Minimum Viable Product, מוצר מינימלי בר-קיימא) הוא הגרסה הפשוטה ביותר של המוצר שיכולה לבחון את היפותזת הערך המרכזית על משתמשים אמיתיים. המטרה היא לא מוצר גמור, אלא חפץ עובד שאפשר להראות למשקיעים ולקבל משוב שוק מהיר. WeCcelerate בונה MVP בדרך כלל תוך 6–12 שבועות.',
      en: 'An MVP (Minimum Viable Product) is the simplest version of a product that can test the core value hypothesis with real users. The goal is not a finished product but a working artifact that can be shown to investors and used for rapid market feedback. WeCcelerate typically builds an MVP within 6–12 weeks.',
    },
  },
  {
  ...
  // -- TRANSACTIONAL / HOW-MUCH --------------------------------------------
  {
    ...
    answer: {
      he: 'MVP בסיסי למובייל: 50,000–150,000 ש"ח (6–12 שבועות). פלטפורמת ווב מלאה: 120,000–400,000 ש"ח (3–6 חודשים). SaaS מורכב עם AI: 250,000 ש"ח ומעלה. העלות תלויה במורכבות, בגודל הצוות ובניסיון של המפתחים.',
      en: 'Basic mobile MVP: 50,000–150,000 ILS (approximately USD 13,500–40,500), 6–12 weeks. Full web platform: 120,000–400,000 ILS, 3–6 months. Complex SaaS with AI: 250,000 ILS+. Cost depends on complexity, team size, and developer seniority.',
    },
  },
  {
    ...
    answer: {
      he: 'חבילת ייעוץ עסקי מלאה (מחקר שוק + תוכנית עסקית + תוכנית פיננסית + תקציר מנהלים + pitch deck): 25,000–80,000 ש"ח ל-4–8 שבועות, תלוי בהיקף. פגישת ייעוץ ראשונה ראשונית ללא עלות.',
      en: 'A full business consulting package (market research + business plan + financial model + executive summary + pitch deck) costs 25,000–80,000 ILS over 4–8 weeks, depending on scope. The initial consultation is free.',
    },
  },
  {
    ...
    answer: {
      he: 'מסלול MedTech מלא עם לאומית: 100,000 ש"ח ומעלה לתוכנית של 12–18 חודשים, הכוללת ייעוץ קליני, גישה לדאטה רפואי אנונימי, פיילוטים במרפאות, הכוונה רגולטורית (CE/FDA/משרד הבריאות) והכנה למשקיעים. מותאם אישית לכל venture.',
  ...
  },
  {
    ...
    answer: {
      he: 'MVP טיפוסי נבנה ב-6–12 שבועות במתודולוגיות Agile ו-Lean Startup. ה-sprint הוא בן שבועיים, עם demo תכוף ליזם. המטרה היא מוצר עובד לבדיקת היפותזה, לא מוצר גמור.',
      en: 'A typical MVP is built in 6–12 weeks using Agile and Lean Startup methodologies. Sprint cadence is two weeks, with frequent demos to the founder. The goal is a working hypothesis-testing artifact, not a finished product.',
    },
  },
  {
    ...
    answer: {
      he: 'תוכנית עסקית ברמת משקיעים נבנית ב-4–8 שבועות, תלוי במורכבות התעשייה וברמת פירוט מחקר השוק. היא כוללת גם תקציר מנהלים של 2–4 עמודים לשליחה ישירה למשקיעים.',
      en: 'An investor-grade business plan is built in 4–8 weeks, depending on industry complexity and market research depth. It also includes a 2–4 page executive summary suitable for sending directly to investors.',
    },
  },
  {
    ...
    answer: {
      ...
      en: 'After a 510(k) submission, FDA review takes an average of 3–6 months. However, preparation — predicate selection, substantial equivalence documentation, performance testing — typically adds 6–12 months. Total: approximately 9–18 months from idea to clearance.',
    },
  },
  {
    ...
    answer: {
      ...
      en: 'CE marking under MDR (Regulation 2017/745) typically takes 12–18 months for Class IIa–IIb devices, up to 24 months for Class III. The process includes ISO 13485, ISO 14971 (risk), IEC 62304 (if software), clinical evaluation, and technical documentation. A Notified Body is required for most classes.',
    },
  },
  {
    ...
    answer: {
      he: 'ליווי שיווקי חודשי ב-WeCcelerate עולה 15,000–60,000 ש"ח לחודש, תלוי בהיקף: ניהול קמפיינים, תוכן, יחסי ציבור, רשתות חברתיות. התחייבות טיפוסית: 6 חודשים לפחות.',
  ...
  },
  {
    ...
    answer: {
      he: 'pitch deck מקצועי עם עיצוב, מודל פיננסי ותרגול — 15,000–40,000 ש"ח, תוך 3–6 שבועות. כולל גם pitch practice וסימולציות מול פרסונות משקיעים.',
      en: 'A professional pitch deck with design, financial modeling, and practice: 15,000–40,000 ILS, delivered over 3–6 weeks. Includes pitch practice and simulations with investor personas.',
    },
  },
  ...
  // -- FUNDRAISING / INVESTMENT --------------------------------------------
  {
    ...
    answer: {
      he: 'גיוס הון מתחיל בהוכחת PMF (Product-Market Fit) ובהכנת pitch deck מקצועי. WeCcelerate מכינה את היזם בסימולציות, בונה את המצגת והמודל הפיננסי, ומחברת ישירות ל-200+ משקיעים ברשת: קרנות הון סיכון (VC), משקיעי אנג\'ל, שותפים אסטרטגיים וקרנות CVC.',
      en: 'Fundraising starts with proving Product-Market Fit and preparing a professional pitch deck. WeCcelerate prepares founders through simulations, builds the deck and financial model, and introduces them directly to 200+ investors in our network: venture capital (VC), angel investors, strategic partners, and CVC funds.',
    },
  },
  {
  ...
  // -- REGULATORY (MedTech) ------------------------------------------------
  {
    ...
    answer: {
      ...
      en: 'The Helsinki Committee is Israel\'s equivalent of the US IRB. Every medical research project involving human subjects or identifiable data requires approval before starting. The process takes 2–4 months and requires a detailed protocol, informed consent form, investigator qualifications, and a data protection plan. WeCcelerate supports the entire submission to Leumit\'s Helsinki Committee.',
    },
  },
  {
    id: 'fda-pathways',
    ...
    answer: {
      ...
      en: '510(k) — the most common pathway; requires demonstrating substantial equivalence to an existing predicate device, 3–6 month review. De Novo — for novel low-to-moderate risk devices without a predicate, creates a new classification, 6–12 months. PMA (Premarket Approval) — for Class III (high risk) devices, requires clinical trials, 12–24 months or longer.',
    },
  },
  {
    id: 'ce-marking-mdr',
  ...
  },
  {
    ...
    answer: {
      ...
      en: 'ISO 13485 is the international quality management system (QMS) standard specific to medical devices. Required for CE and strongly preferred for FDA. Establishing a compliant QMS takes 6–12 months and requires ongoing surveillance audits by a certification body.',
    },
  },
  {
    id: 'israeli-moh-amar',
  ...
  // -- LEUMIT / MEDTECH SPECIFIC -------------------------------------------
  {
    ...
    answer: {
      he: 'שלושה נכסים שקשה מאוד להשיג בשוק: (1) גישה לדאטה רפואי אנונימי longitudinal של 720,000+ מבוטחים ו-8.7 מיליון ביקורים קליניים שנתיים — לאימון ML, מחקרים retrospective ו-real-world evidence; (2) פיילוטים קליניים במרפאות לאומית עם רופאים ומטופלים; (3) קשרים מובנים עם רופאים-יועצים של לאומית. בנוסף — ההמלצה של לאומית היא חותם מהותי מול משקיעים בבריאות.',
      en: 'Three assets that are extremely difficult to obtain on the open market: (1) longitudinal anonymized medical data from 720,000+ insured members and 8.7 million annual clinical visits — for ML training, retrospective studies, and real-world evidence; (2) clinical pilots in Leumit\'s clinics with real physicians and patients; (3) structured relationships with Leumit-affiliated physician advisors. Additionally, the Leumit endorsement is a significant signal to healthcare investors.',
    },
  },
  {
  ...
  },
  {
    ...
    answer: {
      he: '(1) ייעוץ עסקי ואסטרטגי — מחקר שוק, תוכנית עסקית, מודל פיננסי, pitch deck. (2) פיתוח מוצר פיזי — הנדסה, prototyping, ייצור המוני. (3) פיתוח מוצר דיגיטלי — web, mobile, SaaS, AI, CTO-as-a-Service. (4) שיווק ויחסי ציבור — דיגיטלי, PR, רשתות חברתיות, מיתוג. (5) מסלול MedTech עם לאומית — ייעוץ קליני, דאטה, פיילוטים, רגולציה. (6) הכנה למשקיעים ומיצוי רשת של 200+ משקיעים.',
  ...
  // -- SUCCESS & TRACK RECORD ----------------------------------------------
  {
    ...
    answer: {
      he: 'חברות הפורטפוליו גייסו יחד מעל USD 150M. רשת של 200+ משקיעים מומחים. 40+ ונצ\'רים נבנו בתוכנית Corporate Venture Building. WeCcelerate מוכרת ע"י רשות החדשנות ישראל, חברה ב-Start-Up Nation Central וב-IATI.',
      en: 'Portfolio companies have collectively raised over USD 150M. Network of 200+ specialized investors. 40+ ventures built in the Corporate Venture Building program. WeCcelerate is recognized by the Israel Innovation Authority and a member of Start-Up Nation Central and IATI.',
    },
  },
  {
    id: 'founding-year',
  ...
  // -- BUSINESS CONSULTING -------------------------------------------------
  {
    ...
    answer: {
      he: '(1) מחקר שוק עם TAM/SAM/SOM; (2) ניתוח תחרות ו-positioning; (3) תוכנית עסקית מלאה (40–80 עמודים); (4) תקציר מנהלים (2–4 עמודים) למשקיעים; (5) מודל פיננסי 3–5 שנים עם CAC, LTV, unit economics ותרחישים; (6) אסטרטגיית GTM ו-sales motion; (7) אסטרטגיית שיווק ומיקום. מסירה תוך 4–8 שבועות.',
      en: '(1) Market research with TAM/SAM/SOM; (2) competitive analysis and positioning; (3) full business plan (40–80 pages); (4) executive summary (2–4 pages) for investors; (5) 3–5 year financial model with CAC, LTV, unit economics, and scenarios; (6) GTM strategy and sales motion; (7) marketing strategy and positioning. Delivery in 4–8 weeks.',
    },
  },
  ...
  // -- INVESTOR NETWORK ----------------------------------------------------
  {
    ...
    answer: {
      he: '200+ משקיעים מומחים: קרנות הון סיכון (VC), זרועות הון סיכון קורפורטיבי (CVC), סינדיקטים של אנג\'לים ומשרדי משפחה (family offices). כל ההיכרויות חמות וממוקדות לתזת המשקיע, לא "spray and pray".',
      en: '200+ specialized investors: venture capital (VC), corporate venture capital (CVC), angel syndicates, and family offices. All introductions are warm and targeted to the investor\'s thesis — not "spray and pray".',
    },
  },
  {
  ...
  },
  {
    ...
    answer: {
      he: 'בונה מיזמים (Venture Builder) הוא ארגון שיוצר ומפתח מספר מיזמים במקביל באמצעות אספקת הצוות התפעולי המלא — פיתוח, מוצר, שיווק, יועצי משפט. שונה מאקסלרטור (שמספק רק מנטורינג) — בונה מיזמים משמש כשותף-מייסד פעיל. WeCcelerate היא בונה המיזמים המוביל בישראל.',
  ...
  },
  {
    ...
    answer: {
      he: 'ארבעה שלבים: (1) בדיקת רעיון ב-30 ראיונות לקוחות, (2) הקמת חברה בע"מ ברשם החברות (3-7 ימים, 1,100 ש"ח), (3) הסכם מייסדים עם Vesting, (4) בניית MVP תוך 6-12 שבועות. WeCcelerate מלווה יזמים בכל ארבעת השלבים תחת תוכנית מעטפת 360°.',
      en: 'Four steps: (1) validate the idea with 30 customer interviews, (2) register a Ltd. company at the Companies Registrar (3-7 days, ~$300), (3) sign a founder agreement with vesting, (4) build an MVP in 6-12 weeks. WeCcelerate, Israel\'s leading Venture Builder, supports founders through all four stages.',
    },
  },
  {
    id: 'mizam-haznek-faq',
  ...
  },
  {
    ...
    answer: {
      he: '7 מקורות עיקריים: Friends-Family-Fools ($50-300K), Angels ($25-500K), Venture Builder (Equity-for-Services), גרנטים של רשות החדשנות (non-dilutive, $100K-$1M), Crowdfunding, VC Seed/A/B, ו-Bootstrapping. WeCcelerate מחברת מיזמים ל-200+ משקיעים מאומתים.',
      en: '7 main sources: Friends-Family-Fools ($50-300K), Angels ($25-500K), Venture Builder (Equity-for-Services), Israel Innovation Authority grants (non-dilutive, $100K-$1M), Crowdfunding, VC Seed/A/B, and Bootstrapping. WeCcelerate connects ventures to 200+ verified investors.',
    },
  },
  {
    id: 'livui-mizmim-faq',
    ...
    answer: {
      he: 'ליווי מיזם הוא מנטור פרטי — שעות ייעוץ נקודתיות (500-2,500 ש"ח/שעה). אקסלרטור — מנטורינג מובנה + הון סיד למחזור 3-6 חודשים, אקוויטי 5-10%. Venture Builder (בונה מיזמים) — תורם צוות תפעולי מלא ועובד בפועל על המיזם, אקוויטי 10-30%. WeCcelerate היא Venture Builder.',
  ...
  },
  {
    ...
    answer: {
      he: 'שלושה שלבים קריטיים: (1) צירוף רופא בכיר לצוות (Chief Medical Officer או יועץ קליני), (2) אישור ועדת הלסינקי למחקר עם בני אדם או מידע מזהה, (3) שותפות לגישה לדאטה רפואית — קופת חולים אידיאלית. תוכנית WeCcelerate × Leumit מעניקה גישה ל-720K תיקי מטופלים אנונימיים ו-8.7M ביקורים שנתיים.',
      en: 'Three critical steps: (1) add a senior physician to the team (Chief Medical Officer or clinical advisor), (2) Helsinki Committee approval for research involving humans or identifiable data, (3) data access partnership — an HMO is ideal. WeCcelerate × Leumit gives access to 720K anonymized patient records and 8.7M annual visits.',
    },
  },
];
