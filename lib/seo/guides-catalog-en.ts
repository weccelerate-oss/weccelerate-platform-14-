...
export const GUIDES_EN: readonly GuideEn[] = [
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'An accelerator mentors an existing team through a fixed program (usually 3 months). A Venture Builder co-founds the startup — contributing daily operational work for 12-24 months. The Venture Builder takes much more equity but gives much more operational value.',
      },
      {
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'For a MedTech founder, Israel offers specific advantages over the US: (a) lower development costs (engineers cost ~60% of the US equivalent), (b) access to Leumit\'s 720,000+ anonymized patient records via WeCcelerate-Leumit, (c) faster clinical pilot timelines thanks to close ties between hospitals and startups, (d) a regulatory pathway through AMAR (Israeli Ministry of Health) that accepts FDA and CE as supporting evidence for most device classes.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'WeCcelerate\'s exclusive partnership with Leumit Health Services provides access to 720,000+ anonymized patient records with 8.7M annual clinical visits — a dataset unavailable through any other Israeli Venture Builder or accelerator. For AI/ML-based MedTech, this data access is often the difference between a viable product and a dead end.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'WeCcelerate-Leumit specifically provides access to: (1) Former FDA senior advisors, (2) 40+ Leumit clinics for clinical pilots, (3) network of 200+ MedTech-specialized investors in Israel and the US, (4) strategic partnership opportunities with pharma companies, (5) regulatory submission support for FDA 510(k), CE, and AMAR.',
        ],
      },
    ],
    howToSteps: [
      ...
      { name: 'Get Helsinki Committee approval', text: 'For any clinical pilot, submit to the hospital\'s Helsinki Committee. Plan for 2-4 months (WeCcelerate-Leumit shortens this to 6-10 weeks).' },
      ...
      { name: 'Submit FDA 510(k) or CE', text: 'Average FDA 510(k) clearance timeline: 3-12 months. CE under MDR: 6-18 months via Notified Body. Budget: $150K-$500K per regulatory filing.' },
    ...
    faqs: [
      {
        ...
        a: 'From incorporation to FDA clearance of a Class II device: typically 3-5 years. Class I devices (minimal regulation): 12-18 months. Class III: 5-10 years.',
      },
      {
      ...
      },
      {
        ...
        a: 'Through the exclusive WeCcelerate-Leumit Health Services partnership: 720,000+ anonymized patient records, 8.7M annual clinical visits, across 40+ Leumit clinics. Essential for AI/ML-based MedTech.',
      },
    ],
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    sections: [
      ...
      {
        heading: 'Timeline: 2-4 months for standard protocols',
        paragraphs: [
    ...
    howToSteps: [
      ...
      { name: 'Write the protocol', text: '50-80 pages. Use the committee template. Hire an experienced medical writer if needed ($5-15K, saves 3-6 weeks of revisions).' },
      ...
      { name: 'Submit and wait for committee meeting', text: 'Most committees meet monthly. Submit at least 3-4 weeks before the meeting date for inclusion in the agenda.' },
      { name: 'Respond to revision requests', text: 'Expect 1-2 revision cycles. Respond quickly (within 1-2 weeks). Slow responses extend the overall timeline proportionally.' },
    ...
    faqs: [
      ...
      },
      {
        ...
        a: '2-4 months for a standard protocol. WeCcelerate-Leumit typically achieves approval in 6-10 weeks due to pre-negotiated templates and direct committee relationships.',
      },
      {
    ...
    ctaServicePath: '/services/medtech-leumit',
    ctaLabel: 'Get Helsinki approval in 6-10 weeks with WeCcelerate-Leumit',
  },
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    speakableAnswer:
      'FDA 510(k) is the most common regulatory pathway for Class II medical devices in the US. An Israeli startup needs to demonstrate "substantial equivalence" to a legally marketed "predicate device." Typical timeline: 3-12 months. Typical cost: $150K-$500K. Required: predicate identification, performance testing, labeling, clinical data (sometimes), and quality system documentation.',
    lastUpdated: '2026-04-24',
    ...
    sections: [
      ...
      {
        heading: 'Timeline: 3-12 months from submission to clearance',
        paragraphs: [
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Typical range: 3-12 months. Well-prepared submissions with strong predicates clear in 3-4 months. Complex AI/ML submissions or novel technologies can take 9-12+ months.',
      },
      {
      ...
      },
      {
        ...
        a: 'A free FDA meeting where you present your proposed 510(k) strategy and get written FDA feedback before investing in testing. Takes 2-3 months to schedule. Saves 6-12 months of revision cycles. Highly recommended.',
      },
    ],
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    howToSteps: [
      ...
      { name: 'Run meetings in parallel (2-4 weeks)', text: 'Schedule all first meetings in a tight 2-4 week window. Creates time pressure and competitive dynamics. Slow rolling = weak signal.' },
      ...
      { name: 'Close via legal due diligence', text: 'Prepare for 4-6 weeks of legal due diligence. Have a startup-experienced Israeli law firm ready (Herzog, Meitar, Gross).' },
    ],
    faqs: [
      {
        q: 'How much should I raise in Pre-Seed?',
        a: '$100K-$500K is typical. Raise what gets you to MVP + first customers in 6-12 months. Raising too much at Pre-Seed means selling too much equity at a low valuation.',
      },
      {
        q: 'What\'s the typical Seed round size in Israel?',
        a: '$1-4M in 2026. Pre-money valuation: $8-20M. From Israeli micro-VCs (Aleph, TLV Partners) and US crossover Seed funds. Aim for 18-24 months of runway.',
      },
      {
        q: 'When should I raise Series A?',
        a: 'When you have clear Product-Market Fit (30%+ Sean Ellis score) and at least $1M ARR for B2B SaaS, or 100K+ monthly active users for B2C. Typically 18-24 months post-Seed.',
      },
      {
      ...
      },
      {
        ...
        a: 'WeCcelerate maintains relationships with 200+ investors across Israel and the US. We warm-intro our portfolio companies, review pitch decks, conduct mock pitches, and negotiate term sheets.',
      },
    ],
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    sections: [
      ...
      {
        heading: 'Step 4 — Build an MVP in 6-12 weeks',
        paragraphs: [
    ...
    howToSteps: [
      ...
      { name: 'Build an MVP in 6-12 weeks', text: 'Simplest version that proves your hypothesis. $10-40K typical budget.' },
      { name: 'Measure retention and look for PMF', text: 'D7, D30 retention. 40%+ "would be very disappointed" in the Sean Ellis test.' },
      { name: 'Raise Seed via WeCcelerate', text: '200+ verified investors, warm intros, term sheet negotiation support.', url: 'https://weccelerate.co.il/contact' },
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        a: 'Legal: 3-7 days. MVP: 6-12 weeks. Seed raise: 3-9 months after MVP. Total from idea to first funding: 9-18 months.',
      },
      {
    ...
    sections: [
      {
        ...
        list: [
          'Basic mobile MVP (iOS+Android, 5-10 screens): $14K-$40K, 8-12 weeks',
          'Web app (simple SaaS): $10K-$22K, 6-8 weeks',
          'Full web platform (SaaS with dashboard, billing, admin): $35K-$110K, 3-6 months',
          'Complex SaaS with AI and integrations: $70K-$190K, 6-12 months',
          'Native mobile app (full, not MVP): $40K-$135K, 4-8 months',
          'App with hardware/IoT: $55K+ for MVP, $135K+ for full',
          'Two-sided marketplace (like Airbnb): $80K-$270K, 6-12 months',
        ],
      },
      {
    ...
    faqs: [
      {
        ...
        a: 'A simple app (5-10 screens, no complex backend, single platform) — $8K-$22K, 4-6 weeks.',
      },
      {
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    speakableAnswer:
      'A successful Israeli startup pitch deck typically includes 10-15 slides: problem, solution, market, product, traction, business model, competition, team, financial projections, the current round, and vision. WeCcelerate builds professional pitch decks within 3-6 weeks, including 5 practice rounds with former-investor advisors.',
    lastUpdated: '2026-04-24',
    ...
    faqs: [
      {
        ...
        a: '6-12 weeks is the standard range. Simple MVP (web SaaS) — 6-8 weeks. Complex MVP with native mobile and AI — 10-14 weeks.',
      },
      {
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    speakableAnswer:
      'CTO as a Service is a model where a startup without a technical founder hires a fractional CTO for 10-20 hours per week. The CTO makes architecture decisions, hires the first engineering team, reviews code, and represents the technical side to investors. WeCcelerate provides this service for Israeli startups for 3-12 months at $4-9K/month.',
    lastUpdated: '2026-04-24',
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Average: 6-12 months. Young startups work from Idea to Seed. Post-Seed startups work 3-6 months until they hire a full-time CTO.',
      },
      {
  ...
  // ---------------------------------------------------------------------------
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: '4-8 weeks for a professional plan. A founder working alone — 3-6 months, with additional polish along the way.',
      },
    ],
