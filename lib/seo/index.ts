...
export const FAQ_DATA = [
  ...
  },
  {
    ...
    answer: {
      ...
      en: 'In the WeCcelerate program, MVP development typically takes 3-6 months, depending on product complexity and regulatory requirements.',
    },
  },
  {
    question: {
...
export function constructMetadata({
  ...
  const ogImageUrl = ogImage || `${SITE_CONFIG.url}/opengraph-image.png`;
