    ...
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;background:#ffffff;border-radius:18px;overflow:hidden;box-shadow:0 6px 24px rgba(7,11,30,0.08);">
      ...
      ${isVeteran ? '' : `<tr>
        <td style="padding:24px 36px 8px;">
          ...
          <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
            ${benefitRow('🧭', 'מסע מרעיון למיזם', '100 השאלות שמשקיעים באמת שואלים, ב-7 תחנות — ענה בקצב שלך וקבל חוות דעת במבט של משקיע על כל תשובה.')}
...
מה מחכה לך בפורטל:
  · מסע מרעיון למיזם — 100 שאלות משקיעים ב-7 תחנות, עם חוות דעת במבט של משקיע
