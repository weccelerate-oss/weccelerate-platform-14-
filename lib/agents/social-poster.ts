...
export async function runSocialPoster(): Promise<SocialPosterResult> {
  ...
  for (const guide of guides) {
    ...
    const prompt =
      ...
      `כתוב:\n` +
      `1. פוסט LinkedIn (עד 120 מילים, עברית, טון מקצועי-אישי, תובנה אחת חזקה מהנושא, בלי האשטגים מיותרים — עד 3, קישור בסוף).\n` +
      `2. פוסט Facebook לקבוצות יזמים (עד 80 מילים, ישיר וחברי, שאלה שמזמינה תגובות, קישור).\n` +
      `3. שלושה hooks של עד 12 מילים לפתיחת סרטון רילס על הנושא.\n\n` +
      `אל תמציא נתונים שלא מופיעים בתקציר. פורמט: כותרות "LinkedIn:", "Facebook:", "Hooks:".`;
