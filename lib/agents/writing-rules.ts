...
6. **אסור להתחייב למחירים**: אסור לצמוד סכום כלשהו לשירות של WeCcelerate — לא "X ש"ח לחבילה", לא "$Y עבור MVP", לא טווח-מחיר שלנו. אם המחיר חייב להיות ברור — תכתוב "היקף בהתאמה אישית, פגישת היכרות חינם".
   **מה כן מותר**: עובדות מספריות על גורם שלישי, כי הן לא התחייבות שלנו ולעיתים הן בדיוק מה שהקורא בא בשבילו — סכומי מענקים של רשות החדשנות, תקרות רגולטוריות, אגרות רשמיות, או תיאור מקובל של השוק כשהוא מיוחס לשוק ולא לנו ("יועצים בישראל גובים בדרך כלל..."). הכלל הפשוט: אם אפשר להבין מהמשפט "זה מה ש-WeCcelerate גובה" — אסור. אם זה נתון על העולם — מותר.
